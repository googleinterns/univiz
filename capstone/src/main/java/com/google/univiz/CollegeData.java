...
/**
 * CollegeData is a class representing a single university/college/institution. These
 * parameters use data parsed from the CollegeScorecard API. This data has been converted from the
